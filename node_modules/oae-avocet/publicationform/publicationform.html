...
<div id="oa-publicationform-form-template"><!--
    ...
    {macro inputLabel(name, label, required, helpText, helpModalId, helpModalText)}
        <label for="oa-publicationform-input-${name}" class="control-label{if required} oa-form-required{/if}" {if helpText}data-toggle="popover" data-trigger="hover" data-content="${helpText}"{/if}>${label}{if helpText} <i class="fa fa-question-circle"></i>{/if}</label>
        {if helpModalId}
    ...
    <form id="oa-publicationform" class="oa-form" role="form" data-ga-label="Publication Form">
        <div class="oa-section oa-form-section">
            <div class="container">
                ...
                ${requiredInputFormGroup('authors', '__MSG__CORRESPONDING_AUTHOR__', '__MSG__EG_IVAN_ROGERS__', '__MSG__THE_CORRESPONDING_AUTHOR_IS_THE_AUTHOR__', 'form-group-correspondingauthor')}
                ...
                <div id="form-group-acceptancedate" class="form-group">
                    ...
                    <div class="clearfix">
                        <div class="oa-datepicker input-group date pull-left">
                            ...
                            <span class="input-group-addon oa-publicationform-trigger-datepicker"><i class="fa fa-calendar"><span class="sr-only">__MSG__DATEPICKER__</span></i></span>
                        </div>
