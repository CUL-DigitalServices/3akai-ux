...
define(['jquery', 'oae.core', 'jquery.fileupload', 'jquery.iframe-transport'], function($, oae) {
    ...
    return function(uid) {
        ...
        // Array containing all mime types supported for file upload
        ...
        var showFileUploadError = function(message) {
            var messages = {
                ...
                'unsupportedFormat': 'Please upload a PDF, Office or Latex file.'
            };
            ...
            $upload.fileupload({
                'add': function(event, data) {
                    ...
                    if (addedFile.size === 0) {
                        ...
                        resetFileUpload();
                    } else if (!_.contains(supportedFormats, addedFile.type)) {
                        showFileUploadError('unsupportedFormat');
                        resetFileUpload();
                    } else {
