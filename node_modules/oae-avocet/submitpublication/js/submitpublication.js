...
define(['jquery', 'oae.core', 'jquery.fileupload', 'jquery.iframe-transport'], function($, oae) {
    ...
    return function(uid) {
        ...
        var uploadFile = function() {
            ...
            oae.api.content.createFile(selectedFile.name, null, 'public', $upload, selectedFile, null, null, null, function(error, content) {
                if (error) {
                    showPanels($welcome, $upload);
                    // Show there was an error
                    showFileUploadError();
        ...
        $('#oa-submitpublication-welcome-help', $rootel).on('show.bs.collapse hide.bs.collapse', function() {
            $('.oa-submitpublication-btn-help i', $rootel).toggleClass('fa-chevron-down fa-chevron-up');
        });
    };
});
