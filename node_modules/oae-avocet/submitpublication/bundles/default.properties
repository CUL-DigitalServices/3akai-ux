CAN_I_UPLOAD_MULTIPLE_FILES = Can I upload more than one file?
DROP_YOUR_FILE_HERE = Drop your file here
HELLO = Hello
MANUSCRIPTS_CAN_BE_UPLOADED_BY_AN_AUTHOR = Manuscripts can be uploaded by an author, or an administrator or librarian on their behalf.
MORE_INFORMATION_BEFORE_UPLOADING = More information before uploading
NO_YOU_CANNOT_UPLOAD_MULTIPLE_FILES = You can only upload one file. Please upload your manuscript. If you need to send us any other files related to this paper (figures, supplementary information etc) you can do so once we have replied to your initial submission. There is no need to upload multiple files for one paper separately.
OOPS = Oops!
TO_UPLOAD_YOUR_MANUSCRIPT = To upload your manuscript
...
YOUR_MANUSCRIPT_HASNT_BEEN_SUBMITTED_YET = Your manuscript hasn't been submitted yet.
